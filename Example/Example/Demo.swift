...
class Demo {
    ...
    func notes() {
        ...
        sequence = Sequence(delay: 0.5, functions: { self.keyboard.highlightKey(noteNumber: 60, color: UIColor.red.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 61, color: UIColor.blue.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 62, color: UIColor.green.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 63, color: UIColor.yellow.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 64, color: UIColor.orange.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 65, color: UIColor.purple.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 66, color: UIColor.red.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 67, color: UIColor.blue.withAlphaComponent(alpha)) }, { self.keyboard.highlightKey(noteNumber: 68, color: UIColor.green.withAlphaComponent(alpha)) }
        )
    }
